...
public class SimpleParser extends Parser {
    ...
    public static final int
            T__0 = 1, WRITE = 2, READ = 3, ID = 4, INT = 5, ADD = 6, NEWLINE = 7, WS = 8, COMMENT = 9;
    public static final int
    ...
    private static final String[] _SYMBOLIC_NAMES = {
            null, null, "WRITE", "READ", "ID", "INT", "ADD", "NEWLINE", "WS", "COMMENT"
    };
    ...
    public static class ProgContext extends ParserRuleContext {
        public List<TerminalNode> NEWLINE() {
            return getTokens(SimpleParser.NEWLINE);
        }
    ...
    public static class ReadContext extends StatContext {
        public TerminalNode READ() {
            return getToken(SimpleParser.READ, 0);
        }

        public TerminalNode ID() {
            return getToken(SimpleParser.ID, 0);
        }

        public ReadContext(StatContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class WriteContext extends StatContext {
        public TerminalNode WRITE() {
            return getToken(SimpleParser.WRITE, 0);
        }
        ...
        public WriteContext(StatContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class SingleContext extends ExprContext {
        ...
        public SingleContext(ExprContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof SimpleListener) ((SimpleListener) listener).enterSingle(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof SimpleListener) ((SimpleListener) listener).exitSingle(this);
        }
    }
    ...
    public static final String _serializedATN =
            "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\13&\4\2\t\2\4\3\t" +
                    ...
                    "\5\3\5\2\2\6\2\4\6\b\2\3\3\2\6\7&\2\20\3\2\2\2\4\32\3\2\2\2\6!\3\2\2\2" +
                    "\b#\3\2\2\2\n\f\5\4\3\2\13\n\3\2\2\2\13\f\3\2\2\2\f\r\3\2\2\2\r\17\7\t" +
                    "\2\2\16\13\3\2\2\2\17\22\3\2\2\2\20\16\3\2\2\2\20\21\3\2\2\2\21\3\3\2" +
                    "\2\2\22\20\3\2\2\2\23\24\7\4\2\2\24\33\7\6\2\2\25\26\7\6\2\2\26\27\7\3" +
                    "\2\2\27\33\5\6\4\2\30\31\7\5\2\2\31\33\7\6\2\2\32\23\3\2\2\2\32\25\3\2" +
                    "\2\2\32\30\3\2\2\2\33\5\3\2\2\2\34\35\5\b\5\2\35\36\7\b\2\2\36\37\5\6" +
                    "\4\2\37\"\3\2\2\2 \"\5\b\5\2!\34\3\2\2\2! \3\2\2\2\"\7\3\2\2\2#$\t\2\2" +
                    "\2$\t\3\2\2\2\6\13\20\32!";
