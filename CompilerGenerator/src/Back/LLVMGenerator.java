...
class LLVMGenerator {
    ...
    public static void substract_i32(String value, String value1) {
        main_text += "%" + reg + " = sub i32 " + value + ", " + value1 + "\n";
        reg++;
    }

    public static void substract_double(String value, String value1) {
        main_text += "%" + reg + " = fsub double " + value + ", " + value1 + "\n";
        reg++;
    }

    public static void div_i32(String value, String value1) {
        main_text += "%" + reg + " = sdiv i32 " + value + ", " + value1 + "\n";
        reg++;
    }

    public static void div_double(String value, String value1) {
        main_text += "%" + reg + " = fdiv double " + value + ", " + value1 + "\n";
        reg++;
    }
}